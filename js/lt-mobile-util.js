...
!function (w) {
    var Util = {
        ...
        startMove: function (obj, json, times, fx, fn) { //运动框架
            ...
            this.requestAnimFrame.cancel(obj.timer);
            obj.timer = this.requestAnimFrame.request(move);
            function now() {
            ...
            function move() {
                ...
                for (var attr in json) {
                    var value = ltTween[fx](scale * times, iCur[attr], json[attr] - iCur[attr], times);
                    ...
                    if (attr.toLowerCase().charAt(0) === "$") {
                        obj.style["t" + attr.substring(2)] = json[attr];
                        obj.style["webkitT" + attr.substring(2)] = json[attr];
                        obj.style["mozT" + attr.substring(2)] = json[attr];
                        obj.style["oT" + attr.substring(2)] = json[attr];
                    };
                }
                if (scale === 1) {
                    ...
                    obj.timer = _this.requestAnimFrame.request(move);
                }
            }
        },
